  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            <Link to="/appointments/create">
              <Button 
                variant="primary" 
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
                size="lg"
              >
            ...
            <Link to="/appointments">
              <Button 
                variant="outline"
                className="border-2 border-indigo-300 text-indigo-700 hover:bg-indigo-50 shadow-md transition-all duration-200"
                size="lg"
              >
                <svg className="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {t('patientDashboard.viewAppointments')}
              </Button>
            </Link>
          </div>
      </div>
          ...
          <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg hover:shadow-xl transition-shadow duration-200 border-0">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-blue-100">{t('patientDashboard.upcomingAppointments')}</p>
          ...
          <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white shadow-lg hover:shadow-xl transition-shadow duration-200 border-0">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-green-100">{t('patientDashboard.recentVisits')}</p>
                  <p className="text-2xl font-bold">{dashboardStats.recentVisits}</p>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-gradient-to-r from-purple-500 to-purple-600 text-white shadow-lg hover:shadow-xl transition-shadow duration-200 border-0">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-purple-100">{t('patientDashboard.pendingBills')}</p>
                  <p className="text-2xl font-bold">{dashboardStats.pendingBills}</p>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-gradient-to-r from-indigo-500 to-indigo-600 text-white shadow-lg hover:shadow-xl transition-shadow duration-200 border-0">
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-indigo-100">{t('patientDashboard.totalTreatments')}</p>
                  <p className="text-2xl font-bold">{dashboardStats.totalTreatments}</p>
                </div>
              </div>
            </div>
          </Card>
              ...
              {upcomingAppointments.length === 0 ? (
                ...
                <div className="space-y-4">
                  {upcomingAppointments.map((appointment) => (
                    <div key={appointment._id} className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100 hover:shadow-md transition-all duration-200">
                      <div className="flex items-start justify-between mb-2">
                <div className="flex-1">
                          <h3 className="font-semibold text-gray-900 mb-1">{appointment.serviceType}</h3>
                          <p className="text-sm text-gray-600 mb-2">{formatDate(appointment.date)} at {formatTime(appointment.timeSlot)}</p>
                          ...
                          {appointment.clinicId && (
                            <p className="text-sm text-gray-600 mt-1">📍 {appointment.clinicId.name}</p>
                          )}
                        </div>
        ...
        {/* Quick Actions */}
        <Card className="mt-8 shadow-lg border-0 bg-gradient-to-r from-gray-50 to-blue-50">
          <div className="p-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Link to="/appointments/create" className="group">
                <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform group-hover:scale-105 border-2 border-transparent group-hover:border-blue-200">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900">{t('patientDashboard.bookAppointment')}</p>
                      <p className="text-xs text-gray-600">{t('patientDashboard.scheduleVisit')}</p>
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <Link to="/appointments" className="group">
                <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform group-hover:scale-105 border-2 border-transparent group-hover:border-green-200">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900">{t('patientDashboard.myAppointments')}</p>
                      <p className="text-xs text-gray-600">{t('patientDashboard.viewHistory')}</p>
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <Link to="/profile" className="group">
                <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform group-hover:scale-105 border-2 border-transparent group-hover:border-purple-200">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900">{t('patientDashboard.myProfile')}</p>
                      <p className="text-xs text-gray-600">{t('patientDashboard.updateInfo')}</p>
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <Link to="/billing" className="group">
                <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform group-hover:scale-105 border-2 border-transparent group-hover:border-yellow-200">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900">{t('patientDashboard.billing')}</p>
                      <p className="text-xs text-gray-600">{t('patientDashboard.viewBills')}</p>
                    </div>
                  </div>
                </div>
              </Link>
